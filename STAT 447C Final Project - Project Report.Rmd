...
the seasonal component, and $_s_1, s_2, ..., s_{12}$ are the initial seasonal
...
# plot(prediction, plot.original = 12) # 'plot.original = 12' plots the last 12 months of the training data along with the forecast
# 
