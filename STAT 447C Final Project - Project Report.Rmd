...
# # Calculate the indices for the year 2020
# start_2020 <- (2020 - start_test[1]) * 12 + 1
# end_2020 <- start_2020 + 11
# 
# # Exclude the year 2020 from the test set
# dat_test_excl_2020 <- dat_test[-(start_2020:end_2020), ]
# 
# # Then create the time series excluding the year 2020
# ts_unrate_test_excl_2020 <- ts(dat_test_excl_2020$UNRATE, 
#                                 start = start_test, 
#                                 frequency = 12)
# 
# # Model specification
...
# prediction <- predict(model, horizon = length(ts_unrate_test_excl_2020), burn = SuggestBurn(0.1, model))
# 
...
# actuals <- as.numeric(ts_unrate_test_excl_2020)
# 
# # MAE
